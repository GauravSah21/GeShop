                ...
                <div className='container-fluid'>
                    <div className='box d-flex align-items-center'>
                        <div className='info'>
                            ...
                            <p>Start You'r Daily Shopping with Gaurav Enterprises</p>
                    ...
                    <div className='container-fluid'>
                        <div className='row'>
                            <div className='col-md-3 part1'>
                                ...
                                <p><LocationOnOutlinedIcon /> <strong>Address</strong>: 45810 Barahathwa-5, Sarlahi, Nepal
</p>
                                <p><HeadphonesOutlinedIcon /> <strong>Call Us:</strong> (+977) - 9844000010 </p>
                                <p><EmailOutlinedIcon /> <strong>Email:</strong> sale@geshop.com.np</p>
