                        ...
                        <div className='col-md-4 cartRightBox'>
                            <div className='card p-4 '>
                                <div className='d-flex align-items-center mb-4'>
                                    <h5 className='col-3 mr-1  mb-0 text-light'>Subtotal</h5>
                                ...
                                <div className='d-flex align-items-center mb-4'>
                                    <h5 className='col-3 mr-1 mb-0 text-light'>Shipping</h5>
                                    <h3 className='ml-auto mb-0 font-weight-bold'><span >Free</span></h3>
                                </div>


                                <div className='d-flex align-items-center mb-4'>
                                    <h5 className=' col-3 mr-1 mb-0 text-light'>Estimate for</h5>
                                    <h3 className='  mb-0 font-weight-bold'>Kathmandu</h3>
                                </div>


                                <div className='d-flex align-items-center mb-4'>
                                    <h5 className='col-3 mr-1 mb-0 text-light'>Total</h5>
                                    <h3 className='ml-auto mb-0 font-weight-bold'><span className='text-g'>
                                    {
                                            cartItems.length !== 0 &&
                                            cartItems.map(item => parseInt(item.price.split(",").join("")) * item.quantity).reduce((total, value) => total + value, 0)
